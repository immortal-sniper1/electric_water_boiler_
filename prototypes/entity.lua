...

{
  ...
  icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "electric-boiler-mk5"},
    max_health = 1900,
    corpse = "small-remnants",
...

{
    ...
    icon = "__electric_water_boiler__/graphics/icons/boiler1-2.png",
  icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "electric-boiler-mk1-2"},
    max_health = 200,
    corpse = "small-remnants",
  collision_box = {{-1.29, -0.79}, {1.29, 0.79}},
    selection_box = {{-1.5, -1}, {1.5, 1}},
...

{
    ...
    icon = "__electric_water_boiler__/graphics/icons/boiler2-2.png",
  icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "electric-boiler-mk2-2"},
    max_health = 400,
    corpse = "small-remnants",
  collision_box = {{-1.29, -0.79}, {1.29, 0.79}},
    selection_box = {{-1.5, -1}, {1.5, 1}},
...

{
    ...
    icon = "__electric_water_boiler__/graphics/icons/boiler3-2.png",
  icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "electric-boiler-mk3-2"},
    max_health = 600,
    corpse = "small-remnants",
  collision_box = {{-1.29, -0.79}, {1.29, 0.79}},
    selection_box = {{-1.5, -1}, {1.5, 1}},
...

{
    ...
    icon = "__electric_water_boiler__/graphics/icons/boiler4-2.png",
  icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "electric-boiler-mk4-2"},
    max_health = 600,
    corpse = "small-remnants",
  collision_box = {{-1.29, -0.79}, {1.29, 0.79}},
    selection_box = {{-1.5, -1}, {1.5, 1}},
...

{
  ...
  icon_size = 32,
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "electric-boiler-mk5-2"},
    max_health = 1900,
    corpse = "small-remnants",
  collision_box = {{-2.79, -1.39}, {2.79, 1.39}},
    selection_box = {{-3, -1.5}, {3, 1.5}},
